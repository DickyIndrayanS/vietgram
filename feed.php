                ...
                <div class="photo">
                    <header class="photo__header">
                        ...
                        <div class="photo__user-info">
                            <span class="photo__author">Milea Cruss</span>
                            <span class="photo__location">Holland</span>
                        </div>
                    </header>
        ...
        ?>
            <div class="photo">
                <header class="photo__header">
                    <img src="images/avatar.jpg" class="photo__avatar" />
                    <div class="photo__user-info">
                        <span class="photo__author">Aleysa Alinsky</span>
                        <span class="photo__location">Germany</span>
                    </div>
                </header>
                <img src="<?php echo $row['url'] ?>" />
                <div class="photo__info">
